                            ...
                            <table id="datatables" class="table">
                                ...
                                @foreach($data as $element)
                                    ...
                                    <tr>
                                        ...
                                        <td class='text-right'>
                                            <a href='{{route('updateOgtater', $element->id)}}' class='btn btn-link btn-warning edit a_edit'><i class='fa fa-edit'></i></a>
                                            <a href='{{route('delete22', $element->id)}}' class='btn btn-link btn-danger remove'><i class='fa fa-times'></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
